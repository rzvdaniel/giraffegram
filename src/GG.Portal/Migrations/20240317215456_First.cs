        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApiKeyEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApiKeyUsers", x => new { x.ApiKeyId, x.UserId });
                    table.ForeignKey(
                        name: "FK_ApiKeyUsers_ApiKeys_ApiKeyEntityId",
                        column: x => x.ApiKeyEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiKeyUsers_ApiKeyEntityId",
                table: "ApiKeyUsers",
                column: "ApiKeyEntityId");
